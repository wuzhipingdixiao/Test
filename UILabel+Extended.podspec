...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "zack"
  # s.authors            = { "zack" => "Zack.Wu@bluepay.asia" }
  # s.social_media_url   = "http://twitter.com/zack"
...
# s.name        = "UILabelExtended"

# s.version      = "1.0.0"

# s.summary      = "UILabelExtended"
...
# s.source_files  =  "UILabel+Extended/*.{h,m}"
# s.source_files  =  "UILabel+Extended", "UILabel+Extended/*.{h,m}"
